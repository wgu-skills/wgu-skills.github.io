      ...
      <div className="py-16 sm:px-2 lg:relative lg:px-0 lg:py-20">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            <Image
              className="absolute bottom-full right-full -mb-56 -mr-72 opacity-50 h-auto"
              src={blurCyanImage}
              alt=""
              width={530}
              height={530}
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Unleash competency-based learning like never before with our modular, open-source skills library.
              </p>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              <Image
                className="absolute -right-64 -top-64 h-auto"
                src={blurCyanImage}
                alt=""
                width={530}
                height={530}
              ...
              />
              <Image
                className="absolute -bottom-40 -right-44 h-auto"
                src={blurIndigoImage}
                alt=""
                unoptimized
                priority
